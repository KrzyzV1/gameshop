  ...
  return (
    <Container className="my-5">
      ...
      <Row className="align-items-center">
        ...
        <Col md={6}>
          ...
          <p>
            ...
            dodawać do koszyka i kupować ulubione gry. Oferujemy zarówno
            najnowsze hity, jak i klasyki, które zapisały się na kartach historii gamingu.
          </p>
      ...
      <Row className="mt-5 text-center">
        <Col>
          <h5>Dołącz do naszej społeczności graczy już dziś!</h5>
          <p>
            Jeśli masz pytania lub potrzebujesz pomocy, skontaktuj się z nami
            przez zakładkę <a href="/contact">Kontakt</a>.
          </p>
        </Col>
      </Row>
    </Container>
